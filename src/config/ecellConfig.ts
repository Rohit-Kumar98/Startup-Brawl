import type { StartupOption, StageConfig } from '../types/game';
...
export const ecellConfig = {
  ...
  buildingLocations: [
    { id: 'stage-mentorship', name: 'E-Cell HQ', x: 450, y: 550, doorX: 450, doorY: 625, color: '#3B82F6', icon: '🏛️' },
    { id: 'stage-technical', name: 'Tech Lab', x: 1100, y: 380, doorX: 1100, doorY: 455, color: '#06B6D4', icon: '💻' },
    { id: 'stage-design', name: 'Design Studio', x: 1900, y: 380, doorX: 1900, doorY: 455, color: '#A855F7', icon: '🎨' },
    { id: 'stage-content', name: 'Content Room', x: 2500, y: 550, doorX: 2425, doorY: 550, color: '#F59E0B', icon: '✍️' },
    { id: 'stage-marketing', name: 'Marketing Hub', x: 2500, y: 1400, doorX: 2425, doorY: 1400, color: '#10B981', icon: '📈' },
    { id: 'stage-media', name: 'Media Lab', x: 1900, y: 1600, doorX: 1900, doorY: 1525, color: '#EC4899', icon: '🎬' },
    { id: 'stage-pr', name: 'PR War Room', x: 1100, y: 1600, doorX: 1100, doorY: 1525, color: '#F43F5E', icon: '🚨' },
    { id: 'stage-sponsorship', name: 'Investor Suite', x: 450, y: 1400, doorX: 525, doorY: 1400, color: '#EAB308', icon: '🤝' },
    { id: 'stage-pitch', name: 'Pitch Arena', x: 1500, y: 1000, doorX: 1500, doorY: 1000, color: '#00F0FF', icon: '🏟️' },
  ],
  ...
  stages: [
    {
      ...
      mentorRole: "Head of Mentorship, E-Cell",
      mentorAvatar: "👩‍💼",
      locationName: "E-Cell HQ",
    ...
    },
    {
      ...
      departmentName: "Technical Lab",
      mentorName: "Arjun Verma",
      mentorRole: "Tech Lead, E-Cell",
      mentorAvatar: "👨‍💻",
      locationName: "Tech Lab",
    ...
    },
    {
      ...
      mentorRole: "Content Lead, E-Cell",
      mentorAvatar: "✍️",
    ...
    },
    {
      ...
      mentorName: "Devansh Rao",
      mentorRole: "Media Head, E-Cell",
      mentorAvatar: "🎬",
    ...
    },
    {
      ...
      mentorName: "Vikram Singhania",
      mentorRole: "BD & Investor Lead, E-Cell",
      mentorAvatar: "🤝",
    ...
    },
    {
      ...
      index: 8,
      departmentKey: "mentorship",
      departmentName: "Pitch Arena",
      mentorName: "VC Judging Panel",
      mentorAvatar: "🏛️",
      locationName: "Pitch Arena",
